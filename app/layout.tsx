...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      >
        <PomodoroProvider>
          <div className="fixed inset-0 -z-10 overflow-hidden bg-[linear-gradient(180deg,#020617_0%,#0f172a_52%,#111827_100%)]">
          ...
          <Toaster />
          <Header />
          <main className="relative z-10 mx-auto flex min-h-[calc(100vh-88px)] w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
            {children}
          </main>
        </PomodoroProvider>
      </body>
